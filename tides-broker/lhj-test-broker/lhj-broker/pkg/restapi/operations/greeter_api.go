...
func NewGreeterAPI(spec *loads.Document) *GreeterAPI {
	return &GreeterAPI{
		...
		HostsAddOneHostHandler: hosts.AddOneHostHandlerFunc(func(params hosts.AddOneHostParams) middleware.Responder {
			return middleware.NotImplemented("operation hosts.AddOneHost has not yet been implemented")
		}),
		HostsFindHostsHandler: hosts.FindHostsHandlerFunc(func(params hosts.FindHostsParams) middleware.Responder {
			return middleware.NotImplemented("operation hosts.FindHosts has not yet been implemented")
		}),
		...
		HostsQueryHostInfoHandler: hosts.QueryHostInfoHandlerFunc(func(params hosts.QueryHostInfoParams) middleware.Responder {
			return middleware.NotImplemented("operation hosts.QueryHostInfo has not yet been implemented")
		}),
	}
}
...
type GreeterAPI struct {
	...
	// HostsAddOneHostHandler sets the operation handler for the add one host operation
	HostsAddOneHostHandler hosts.AddOneHostHandler
	// HostsFindHostsHandler sets the operation handler for the find hosts operation
	HostsFindHostsHandler hosts.FindHostsHandler
	// GetGreetingHandler sets the operation handler for the get greeting operation
	GetGreetingHandler GetGreetingHandler
	// HostsQueryHostInfoHandler sets the operation handler for the query host info operation
	HostsQueryHostInfoHandler hosts.QueryHostInfoHandler
...
func (o *GreeterAPI) Validate() error {
	...
	if o.HostsAddOneHostHandler == nil {
		unregistered = append(unregistered, "hosts.AddOneHostHandler")
	}
	if o.HostsFindHostsHandler == nil {
		unregistered = append(unregistered, "hosts.FindHostsHandler")
	}
	if o.GetGreetingHandler == nil {
		unregistered = append(unregistered, "GetGreetingHandler")
	}
	if o.HostsQueryHostInfoHandler == nil {
		unregistered = append(unregistered, "hosts.QueryHostInfoHandler")
	}
...
func (o *GreeterAPI) initHandlerCache() {
	...
	o.handlers["POST"]["/addHost"] = hosts.NewAddOneHost(o.context, o.HostsAddOneHostHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/addHost"] = hosts.NewFindHosts(o.context, o.HostsFindHostsHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	...
	o.handlers["GET"]["/hostsStatus"] = hosts.NewQueryHostInfo(o.context, o.HostsQueryHostInfoHandler)
}
